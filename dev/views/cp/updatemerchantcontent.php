<?php foreach($merchantcontents as $cont):?>
<?php echo form_open_multipart('cp/updatemerchantcontent/'.$id); ?>
...
<table width="100%">
     ...
     <tr>
         <td>Nội dung</td>
         <td>
              <textarea rows="30" cols="100" name="des" id="des"><?php echo $cont->des?></textarea>
              <script>
