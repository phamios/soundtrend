...
$sBaseRoot2="";
$sBaseRoot3="";
$sBaseRoot0=$sitename;ereg_replace($sBaseVirtual0,"",$sBase0); //output: "c:/inetpub/wwwroot"
...
function getAction()
  ...
  if(sQueryString.indexOf("=")==-1)
    {//no querystring
    sAction="uploadfiles.php?ffilter="+document.getElementById("selFilter").value;
    }
  else
    {
    sAction="uploadfiles.php?"+sQueryString+"&ffilter="+document.getElementById("selFilter").value
    }
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  return sAction;
  }
...
function Ok()
  {
  window.opener.SetImagesValues(document.getElementById("inpSource").value);
  bOk=true;
  window.close();
  }
function doUnload()
  {
    if(!bOk)window.opener.SetImagesValues("");
  }
</script>
</head>
...
<td valign=top style="background:url('bg.gif') no-repeat right bottom;padding-top:5px;padding-left:5px;padding-right:5px;padding-bottom:0px;">
    ...
    <td valign=top align="center">
      <table width=100% cellpadding=0 cellspacing=0>
       <tr>
        <td>
          <div id="idPreview" style="text-align:center;overflow:auto;width:300;height:245;border:#0099CC 3px solid;border-bottom:#0099CC 1px solid;background:#ffffff;margin-right:2;"></div>
          <div align=center><input type="text" id="inpSource" name="inpSource" style="border:#0099CC 2px solid;width:300" class="inpTxt"></div>
        </td>
...
<td class="dialogFooter" style="height:40px;padding-right:15px;" align="right" valign="middle">
  ...
  <tr>
  <td>
  <input name="btnOk" id="btnOk" type="button" value=" Ok " onClick="Ok()" class="inpBtn" onMouseOver="this.className='inpBtnOver';" onMouseOut="this.className='inpBtnOut'">
  </td>
  </tr>
  </table>
</td>
