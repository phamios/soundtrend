...
function getAction()
  ...
  if(sQueryString.indexOf("=")==-1)
    {//no querystring
    sAction="uploadmedia.php?ffilter="+document.getElementById("selFilter").value;
    }
  else
    {
    sAction="uploadmedia.php?"+sQueryString+"&ffilter="+document.getElementById("selFilter").value
    }
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  return sAction;
  }
...
function Ok()
  {
  window.opener.SetMediaValues(document.getElementById("inpSource").value);
  bOk=true;
  window.close();
  }
function doUnload()
  {
    if(!bOk)window.opener.SetMediaValues("");
  }
</script>
</head>
