...
//$sBaseRoot0= preg_match("",$sBaseVirtual0,$sBase0);
...
$MaxFileSize = 3145728;
$AllowedTypes = "gif|jpg|png|avi|wmv|mpg|mpeg|wav|wma|mid|mp3|flv|swf|doc|txt|xls|zip|rar";
// $AllowedTypes = "*";
    ...
    if($sItem=="."||$sItem=="..")
      ...
      if(!$fIsDirectory)
        ...
        if($bDisplay)
          ...
          $sCurrent_virtual=str_replace("../","",$sCurrent);
          ...
          $sCurrent_virtual=$host.''.$sCurrent_virtual; 
